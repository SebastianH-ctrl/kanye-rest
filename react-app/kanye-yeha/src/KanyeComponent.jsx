...
>>>>>>> 4ecd6b33ccb3e32954f26e6a3e83c6bf6a446334
...
<<<<<<< HEAD
  ...
  const handleStarClick = () => {
    ...
    if (isStarFilled) {
      ...
      kanyeFavs = kanyeFavs.filter((fav) => fav.quote !== props.quote);
    } else {
      // Add quote to favorites if the star is not filled
      kanyeFavs.push({ quote: props.quote, audioPath: props.audioPath });
    }
    ...
    <div className="container" id="innerKanye">
      <div className="star-container">
        ...
        >
          <svg width="20" height="20">
            <polygon
              points="10,0.8 13,7.2 20,7.2 14,11.6 16,18.4 10,14.4 4,18.4 6,11.6 0,7.2 7,7.2"
              stroke="yellow"
              strokeWidth="1"
      ...
      <div className="blockquote-wrapper">
        <div className="blockquote">
          <h1>{props.quote}</h1>
          <h4>
            &mdash; Kanye West - <em>Twitter user</em>
          </h4>
        </div>
      </div>
      <div>
